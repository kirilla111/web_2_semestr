<template>
  <body v-bind:class="[{ darkMode: isSwitched }, { lightMode: !isSwitched }]">
    ...
    <main>
      <div class="main__add_card_container">
        ...
        <div class="add_card_container__form">
          <input
            id="options"
            v-bind:class="[
              { darkMode_input: isSwitched },
              { lightMode_input: !isSwitched },
            ]"
            type="text"
            size="40"
      ...
      <div class="main__tasks_container">
        <board :id="'board-1'" :title="'План'" :colIndex="1">
          <card
            v-for="(col, index) in tasksContainers"
            :key="index"
            v-bind:class="[
              { darkMode_c: isSwitched },
              { lightMode_c: !isSwitched },
            ]"
            :id="col.id"
            :title="col.title"
            :colIndex="1"
        ...
        <board :id="'board-2'" :title="'В работе'" :colIndex="2"> </board>
        <board :id="'board-3'" :title="'Готово'" :colIndex="3"> </board>
      </div>
    </main>
    ...
    <div
      id="form_id"
      v-bind:class="[
        { form_dark_mode: isSwitched },
        { form_light_mode: !isSwitched },
      ]"
    >
          ...
          >
            ...
            <div>
              <div
                id="myDropdown"
                v-bind:class="[
                  { dropdown_content_dark_mode: isSwitched },
                  { dropdown_content_light_mode: !isSwitched },
                ]"
              >
                <div
                  class="dropdown-content__text"
...
export default {
  ...
  methods: {
    ...
    createCard() {
      ...
      this.tasksContainers.push({
        id: `card${this.card_count}`,
        title: `${card_title}`,
        colIndex: 1,
        date_start: new Date(),
      });
    ...
    saveAndClose() {
      ...
      var dropdown_text = document.getElementById(
        "dropdown_text__name"
      ).innerHTML;
